...
- `Afinz-CRM-Midia-Vault/05-Estrategia/Report-Live-Arquitetura-Editorial.md`: 10 famílias editoriais, régua e compactação 57→31/12.
...
- `report-live-engine.ts`: seleção determinística dos perfis de 12 e 31 slides.
...
| Modelo editorial determinístico | Report Live engine | slides selecionados, números, comparações, vereditos e limites |
