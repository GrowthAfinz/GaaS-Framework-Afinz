    ...
    <AppErrorBoundary>
      ...
      {hasData && (
        <div className="sticky top-0 z-30" ref={filterShellRef}>
          <div
            className={`
              bg-gradient-to-b from-afinz-ice/95 to-white/95 backdrop-blur-md border-b border-cyan-300/70 shadow-[0_4px_12px_rgba(0,198,204,0.08)] transform-gpu origin-top
