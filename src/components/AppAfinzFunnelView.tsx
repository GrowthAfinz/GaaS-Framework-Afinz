...
export const AppAfinzFunnelView: React.FC<{ navigation: React.ReactNode }> = ({ navigation }) => {
  ...
  return <div className="min-h-full bg-slate-50 px-4 pb-6 text-slate-800">
    <div className="mx-auto max-w-[1780px] space-y-4">
      ...
      >
      <section className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 px-4 py-3">
