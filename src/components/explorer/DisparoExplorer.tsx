  ...
  const storeActivities = React.useMemo(() => {
    ...
    return sourceActivities.map((a) => {
      ...
      return {
        ...
        'Oferta 2': a.oferta2 || a.raw['Oferta 2'],
        'Promocional 2': a.promocional2 || a.raw['Promocional 2'],
        Produto: a.produto || a.raw.Produto,
        'Etapa de aquisição': a.etapaAquisicao || a.raw['Etapa de aquisição'],
