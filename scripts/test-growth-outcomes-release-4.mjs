  ...
  const result = psql(['-q', '-t', '-A'], `
    ...
    begin
      ...
      insert into public.report_action_candidates(
        ...
        (no_execution_id, run_id, 'VIEW_TEST', 'crm:no-execution', 'NO_EXECUTION', 'crm', 'Acompanhar', 'Sem execução', '[]', 'Executar ação', 'metric', 'confirmed', 'test', 10, 'count', 'maior_melhor', (now() at time zone 'America/Sao_Paulo')::date - 1, 'VIEW_TEST'),
        (partial_id, run_id, 'VIEW_TEST', 'crm:partial', 'PARTIAL_EXECUTION', 'crm', 'Acompanhar', 'Execução parcial', '[]', 'Executar ação', 'metric', 'confirmed', 'test', 10, 'count', 'maior_melhor', (now() at time zone 'America/Sao_Paulo')::date - 1, 'VIEW_TEST'),
        (completed_id, run_id, 'VIEW_TEST', 'crm:completed', 'COMPLETED_EXECUTION', 'crm', 'Acompanhar', 'Execução completa', '[]', 'Executar ação', 'metric', 'confirmed', 'test', 10, 'count', 'maior_melhor', (now() at time zone 'America/Sao_Paulo')::date - 1, 'VIEW_TEST'),
        (due_id, run_id, 'VIEW_TEST', 'crm:due', 'DUE_WITHOUT_RESULT', 'crm', 'Acompanhar', 'Vencida sem medição', '[]', 'Executar ação', 'metric', 'confirmed', 'test', 10, 'count', 'maior_melhor', (now() at time zone 'America/Sao_Paulo')::date - 1, 'VIEW_TEST');
      ...
      bet_no_execution := public.growth_accept_signal_as_bet(no_execution_id, 'CRM', 'Hipótese sem execução', 'Executar ação', 'metric', 5, 10, 'maior_melhor', 'metric >= 10', (now() at time zone 'America/Sao_Paulo')::date - 10, (now() at time zone 'America/Sao_Paulo')::date - 1, 'VIEW_TEST');
      bet_partial := public.growth_accept_signal_as_bet(partial_id, 'CRM', 'Hipótese parcial', 'Executar ação', 'metric', 5, 10, 'maior_melhor', 'metric >= 10', (now() at time zone 'America/Sao_Paulo')::date - 10, (now() at time zone 'America/Sao_Paulo')::date - 1, 'VIEW_TEST');
      bet_completed := public.growth_accept_signal_as_bet(completed_id, 'CRM', 'Hipótese completa', 'Executar ação', 'metric', 5, 10, 'maior_melhor', 'metric >= 10', (now() at time zone 'America/Sao_Paulo')::date - 10, (now() at time zone 'America/Sao_Paulo')::date - 1, 'VIEW_TEST');
      bet_due := public.growth_accept_signal_as_bet(due_id, 'CRM', 'Hipótese vencida', 'Executar ação', 'metric', 5, 10, 'maior_melhor', 'metric >= 10', (now() at time zone 'America/Sao_Paulo')::date - 10, (now() at time zone 'America/Sao_Paulo')::date - 1, 'VIEW_TEST');
      ...
      insert into public.report_action_outcomes(
        ...
        (no_execution_id, 'metric', 5, 10, 4, 'count', (now() at time zone 'America/Sao_Paulo')::date - 10, (now() at time zone 'America/Sao_Paulo')::date - 1, now(), 'nao_confirmado', 'Abaixo da expectativa.', 'VIEW_TEST', 'linha_de_metrica'),
        (partial_id, 'metric', 5, 10, 4, 'count', (now() at time zone 'America/Sao_Paulo')::date - 10, (now() at time zone 'America/Sao_Paulo')::date - 1, now(), 'nao_confirmado', 'Abaixo da expectativa.', 'VIEW_TEST', 'linha_de_metrica'),
        (completed_id, 'metric', 5, 10, 4, 'count', (now() at time zone 'America/Sao_Paulo')::date - 10, (now() at time zone 'America/Sao_Paulo')::date - 1, now(), 'nao_confirmado', 'Abaixo da expectativa.', 'VIEW_TEST', 'linha_de_metrica');
