...
values
  ($dia$dia-crm-dynamic-v1$dia$, $dia$DIA CRM - Régua dinâmica v1$dia$, $dia$%%[
...
<body style="margin:0;padding:0;background:#ffffff;font-family:Arial,Tahoma,sans-serif;color:#111827">
...
</table></td></tr></table></body></html>$dia$, false, 'active', 1, null, null)
...
set template_slot_id = $dia$dia-crm-dynamic-v1$dia$,
    version = version + 1,
    updated_at = now()
...
begin
  ...
  where lower(partner) = 'dia'
    and upper(segment) = 'CRM'
    and briefing_data->>'NM_PRODUTO_INTERNO' = 'DIA'
    and template_slot_id = $dia$dia-crm-dynamic-v1$dia$;
  if affected <> 8 then
