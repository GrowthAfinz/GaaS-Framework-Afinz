...
with variants(sequence_no, week_no, subject, preheader, header_url, banner_1, banner_2, copy_1, title_2, copy_2, role_in_ruler, email_objective, key_message) as (
  ...
  select jsonb_build_object(
    ...
    'NOTA_LEGAL','*Desconto de R$20 disponível em até 10 dias após a ativação do cartão. Válido por 15 dias no app Club Dia, apenas para a primeira compra acima de R$120. Para garantir a ativação, é necessário utilizar o cartão em qualquer estabelecimento. / **Desconto de 5% disponível após realizar uma compra por mês, conforme as condições do Club Dia e exceto commodities. / ***Os créditos do Club Dia dependem da quantidade e do valor das compras, conforme as regras vigentes no aplicativo. / ****Para acessar os benefícios, identifique-se no caixa com o CPF, esteja logado no app Club Dia e ative os descontos em Meus Cupons. / *****Programa Você Bem com isenção de 6 meses. Sujeito à análise de crédito. Após a primeira compra com o cartão e anuidade ativa, você receberá em até 5 dias úteis R$100 em créditos no App Vibe, válidos por até 6 meses. A primeira compra deve ocorrer em até 30 dias. A cada fatura paga, com anuidade ativa, você poderá receber mais créditos conforme as condições da loja parceira. Consulte os regulamentos completos nos aplicativos Club Dia e Vibe. Promoções válidas por tempo limitado e sujeitas a disponibilidade.',
